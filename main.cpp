...
//    engine_board.unmake_move(34);
//    engine_board.unmake_move(35);
//    engine_board.unmake_move(36);
//    engine_board.unmake_move(37);
//    engine_board.unmake_move(38);
//    engine_board.unmake_move(39);
//    engine_board.unmake_move(40);
//    engine_board.unmake_move(41);
//    engine_board.unmake_move(42);
